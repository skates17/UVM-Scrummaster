...
//    }
    ...
    $driverName = htmlentities($_POST["txtDriverName"], ENT_QUOTES, "UTF-8");
    ...
    if (!$errorMsg) {
        ...
        $query="INSERT IGNORE INTO tblReviews(fldStatus, fldRating, fldComments, fldNice, fldFunny, fldGoodDriver, fldGoodMusic, fldBadDriver, fldUncomfortable, fldMean, fldLate, fnkNetId,fnkRevieweesNetId) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $data=array($status,$rating,$comments,$nice1,$fun1,$goodDriver1,$goodMusic1,$badDriver1,$uncomfortable1,$mean1,$late1, $username, $revieweeId);
        ...
        foreach ($_POST as $key => $value) {
            ...
            // txtDriverName becomes First Name
    ...
    <form action="<?php print $phpSelf; ?>"
          ...
          method="post">
                <fieldset class="radio">
                    ...
                    Are you Reviewing the Driver or Passenger?
                            ...
                            <label class="rad"><input type="radio"
                                          ...
                                          name="radType"
                                          value="Driver"
                                          <?php if ($style == "Driver") print 'checked' ?>
                                          tabindex="340">Driver</label>
                </fieldset>
                <fieldset class="text">
                    <legend>Contact Information</legend>

                    <label class="required" for="txtDriverName">Reviewee's Email*
                        <br>
                        <input autofocus
                ...
                <fieldset class="checkbox <?php if ($activityERROR) print ' mistake'; ?>">
                    <legend>Description</legend>
                            ...
                            <label class="chk"><input type="checkbox"
                                    ...
                                    name="chk3"
                                    value="goodDriver"
                                    <?php if($goodDriver) print'checked';?>
                                    tabindex="520">Good Driver</label>
                            ...
                            <label class="chk"><input type="checkbox"
                                    ...
                                    name="chk5"
                                    value="badDriver"
                                    <?php if($badDriver) print'checked';?>
                                    tabindex="540">Bad Driver</label>
                            <label class="chk"><input type="checkbox"
                                    id="checkbox"
                                    name="chk6"
                                    value="uncomfortable"
